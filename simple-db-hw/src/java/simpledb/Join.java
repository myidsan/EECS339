...
public class Join extends Operator {
    ...
    private Tuple currLeftTuple = null;
    ...
    protected Tuple fetchNext() throws TransactionAbortedException, DbException {
        ...
        while (currLeftTuple != null || child1.hasNext()) {
            ...
            while (child2.hasNext()) {
                ...
                // from both tuples
                if (!pred.filter(currLeftTuple, rightTuple))
                    continue;

                int td1n = currLeftTuple.getTupleDesc().numFields();
                int td2n = rightTuple.getTupleDesc().numFields();

                // set fields in combined tuple
                Tuple t = new Tuple(comboTD);
                for (int i = 0; i < td1n; i++)
                    t.setField(i, currLeftTuple.getField(i));
