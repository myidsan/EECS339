...
public class HeapPage implements Page {
    ...
    private volatile TransactionId dirtyTid;
    ...
    */
    private int getNumTuples() {
        // some code goes here
        int tupNumPerPage = (int)Math.floor((BufferPool.getPageSize()*8)/(td.getSize()*8+1));
        return tupNumPerPage;
